...
public class ServidorBanco extends UnicastRemoteObject implements IOperacionesEmpresa {
    /**
     *
     */
    ...
    public Factura[] calcular(int idcliente) throws RemoteException {
        ...
        try {
            ...
            System.arraycopy(FacturasPendientesElapas, 0, FacturasPendientes, FacturasPendientesCessa.length,
                    FacturasPendientesElapas.length);
    ...
    public static void main(String args[]) {
        ...
        try{
            ...
            String name="Pagar";
            pagar=pagarHelper.narrow(ncRef.resolve_str(name));
            System.out.println(pagar.class);
            }catch(Exception e){
